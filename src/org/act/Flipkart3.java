...
public class Flipkart3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement babyAndKids=driver.findElement(By.xpath("(//span[@class='_2I9KP_'])[5]"));
		a.moveToElement(babyAndKids).perform();
		Thread.sleep(3000);
			
		WebElement remoteCntrlToys=driver.findElement(By.xpath("//a[text()='Remote Control Toys']"));
		remoteCntrlToys.click();
